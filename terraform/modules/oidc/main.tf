...
# Policy to allow GitHub Actions to push to ECR
...
# Policy to allow GitHub Actions to push to S3 frontend bucket
resource "aws_iam_policy" "s3_push_policy" {
  name        = "${var.project_name}-s3-push-policy"
  description = "Allows GitHub Actions to push to S3 frontend bucket"
